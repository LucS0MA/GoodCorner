...
export type Query = {
  ...
  getAllTempsUsers: Array<TempUser>;
  getCategoryById: Category;
  getTagById: Tag;
  getTempUserById: TempUser;
...
export type QueryGetTempUserByIdArgs = {
  id: Scalars['Float']['input'];
};
...
export type TempUser = {
  ...
  randomCode: Scalars['String']['output'];
};
...
export type ConfirmPasswordMutation = { __typename?: 'Mutation', confirmPassword: string };
...
export type GetAllCategoriesAndUserInfoQuery = { __typename?: 'Query', getAllCategories: Array<{ __typename?: 'Category', id: number, title: string }>, getUserInfo: { __typename?: 'UserInfo', isLoggedIn: boolean, email?: string | null } };
